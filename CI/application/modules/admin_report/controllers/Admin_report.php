...
class Admin_report extends CI_Controller
{
	...
	{
		$arr		= $this->admin_report_model->get_report_detail($id);
	...
	public function view_pdf(){
	    ...
	    $data['rec'] 	= $this->admin_report_model->get_report_pdf()->result_array(); 
	    $html = $this->load->view('view_pdf', $data, true);
	    $fileName = "Report-Kejaksaan".".".md5(uniqid());
	    $this->pdf->pdf_create($html, $fileName,'A4', 'landscape');
	}

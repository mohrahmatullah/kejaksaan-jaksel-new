      ...
      <div class="wrapper d-none d-lg-block">
        ...
        <img src="<?= ASSETS_IMAGE ?>/bg_menu.png" class="position-fixed" style="right: 0;width: 5.9vw;height: 100vh;z-index: -1" />
        
        <section class="profile-sec">
          <div class="p-s1">
            <div class="p-set">
              <a href="<?= base_url('change-password') ?>"><img src="<?= ASSETS_IMAGE ?>/ico_gear.png" /></a>
            </div>
            <div class="p-name text-right">
              <div style="font-size: 1.3em;font-weight: 700;"><?= ucwords($this->session->userdata('user_login_nama')) ?></div>
              <div style="font-size: 1.1em;font-weight: 500;"><?= $this->session->userdata('user_login_jabatan') ?></div>
            </div>
            
          </div>
          <div class="p-s2">
            <div class="p-ava">
              <img class="img-ava" src="<?= ASSETS_IMAGE ?>/default_pp_s.png" />
              <img class="img-on" src="<?= ASSETS_IMAGE ?>/on_img.png" />
            </div>
          </div>
        </section>
        ...
        <nav class="nav-sec">
          <ul class="list-unstyled">
            <li class="nav-m"><a href="<?= base_url() ?>" class="nav-l active" title="dashboard"><img class="nav-img h-auto" src="<?= ASSETS_IMAGE ?>/home_icon.png" /></a></li>
            <? if ($this->session->userdata('user_login_level') == 'superadmin'){ ?>
            <li class="nav-m"><a href="<?= base_url('pegawai') ?>" class="nav-l " title="pegawai" ><img class="nav-img h-auto" src="<?= ASSETS_IMAGE ?>/pegawai.png" /></a></li>
            <li class="nav-m"><a href="<?= base_url('peraturan-jaksa-agung') ?>" class="nav-l " title="peraturan jaksa agung"><img class="nav-img h-auto" src="<?= ASSETS_IMAGE ?>/jaksa.png" /></a></li>
            <li class="nav-m"><a href="<?= base_url('sop') ?>" class="nav-l " title="sop"><img class="nav-img h-auto" src="<?= ASSETS_IMAGE ?>/sop.png" /></a></li>
            <li class="nav-m"><a href="<?= base_url('uraian-kerja') ?>" class="nav-l " title="sprint"><img class="nav-img h-auto" src="<?= ASSETS_IMAGE ?>/task_ico.png" /></a></li>
            <? } ?>
            <li class="nav-m"><a href="<?= base_url('verification-file')?>" class="nav-l " title="verifikasi sprint"><img class="nav-img h-auto" src="<?= ASSETS_IMAGE ?>/v-sprint.png" /></a></li>
            <!-- <li class="nav-m"><a href="<?= base_url('report')?>" class="nav-l " title="report"><img class="nav-img h-auto" src="<?= ASSETS_IMAGE ?>/report.png" /></a></li> -->
            <li class="nav-m"><a href="<?= base_url('logout') ?>" class="nav-l " title="logout"><img class="nav-img h-auto" src="<?= ASSETS_IMAGE ?>/logout.png" /></a></li>
          </ul>
        </nav>
        ...
        <header style="height: 16.5vh">
          <nav class="header-sec">
            <div class="logo-sec">
              <img src="<?= ASSETS_IMAGE ?>/logo_text.png" class="w-100 h-auto"/>
            </div>
          </nav>
        </header>
        <!-- /Navbar Header -->
      ...
      <div class="wrapper-m d-block d-lg-none">
        <header class="p-3" style="background: linear-gradient(to right, rgb(254,193,0) , rgb(247,228,0));height: 66px;">
          <div class="brand-m">
            <img src="<?= ASSETS_IMAGE ?>/logo_text.png" style="width: 140px;height: auto;" />
          </div>
        </header>
        ...
        <section class="profile-sec-m">
          <div class="p-s1-m">
            <div class="p-set-m">
              <a href=""><img src="<?= ASSETS_IMAGE ?>/ico_gear.png" /></a>
            </div>
            <div class="p-name-m text-right">
              <div style="font-size: 8pt;font-weight: 700;"><?= ucwords($this->session->userdata('user_login_nama')) ?></div>
              <div style="font-size: 7pt;font-weight: 500;"><?= $this->session->userdata('user_login_jabatan') ?></div>
            </div>
            
          </div>
          <div class="p-s2-m">
            <div class="p-ava-m">
              <img class="img-ava-m" src="<?= ASSETS_IMAGE ?>/default_pp_s.png" />
              <img class="img-on-m" src="<?= ASSETS_IMAGE ?>/on_img.png" />

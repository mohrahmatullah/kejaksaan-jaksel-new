        ...
        <!-- <div id="content" class="col-md-12"> -->
          ...
          <!-- <div class="breadcrumbs">
            <ol class="breadcrumb">
              ...
              <li class="active">SOP Kejaksaan Negeri</li>
						</ol>
          </div> -->
          <!-- /breadcrumbs -->
      ...
      <div class="main" id="content" style="overflow-x: hidden;">
        <section class="px-xl-5">
          <section class="px-3 mt-3 mb-4 d-none d-lg-block">
            <div style="font-size: 2em;font-weight: 500;">SOP &nbsp;<a id="carireset" href="javascript:void(0);" onclick="carireset();" title="reset"><img class="" src="<?= ASSETS_IMAGE ?>/ico_ref.png" style="width: 50px;height: auto;" /></a></div>
          </section>
          <section>
            <div id="ajax_page">
